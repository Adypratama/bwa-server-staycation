...
module.exports = {
    viewSignin : async (req, res, next) => {
        try {
            ...
            if ( req.session.user == null || req.session.user == undefined) {
                res.render('index', {
                    alert,
                    title: 'LOGIN | FUNTRAWORLD',
                });// render untuk megakses file bukan url
            } else {
    ...
    actionSignin : async (req, res) => {
        try {
            ...
            if(!user) {
            req.flash('alertMassage', 'Username tidak ditemukan');
            req.flash('alertStatus', 'danger');
            res.redirect('/admin/signin'); //yang di akses routing bukan file
            }
                const isPasswordMatch = await bcrypt.compare(password, user.password); // mencocokan password yg sudah di enskripsi dengan data base
                if(!isPasswordMatch) {
                    req.flash('alertMassage', 'Password anda salah');
                    req.flash('alertStatus', 'danger');
                    res.redirect('/admin/signin');
                }
    ...
    addCategory:async (req, res) => {
        try {
            ...
            req.flash('alertMassage', `${error.message}`);
            req.flash('alertStatus', 'danger');
    ...
    showDetailBooking : async (req, res) => {
        ...
        try {
            ...
            title: 'Detail Booking | FUNTRAWORLD',
            user: req.session.user,
            booking,
            alert
        });
    ...
    actionConfirmation : async (req, res) => {
        ...
        try {
            ...
            req.flash('alertMassage', 'Success Confirmation Pembayaran ');
            req.flash('alertStatus', 'primary');
    ...
    actionReject : async (req, res) => {
        ...
        try {
            ...
            req.flash('alertMassage', 'Success Reject Pembayaran ');
            req.flash('alertStatus', 'primary');
            res.redirect(`/admin/booking/${id}`);
